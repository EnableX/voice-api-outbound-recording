...
## Installation
- `git clone https://github.com/EnableX/voice-api-outbound-recording.git`
- `cd voice-api-outbound-recording`
- `npm install`
...
For Windows:
  - Make a file with name ".env" in root directory . And copy content of .env.example in .env file . Then set these variables manually in .env file.
...
For Windows:
  - In that .env file also update the values of `PUBLIC_WEBHOOK_URL` , `LISTEN_SSL`.
...
- For Outbound Calls,
  - `node client-outbound-recording.js`
